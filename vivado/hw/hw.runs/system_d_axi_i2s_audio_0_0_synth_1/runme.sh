...
HD_PWD='D:/WorkRaduV/Projects/Zybo-Z7/hw/proj/hw.runs/system_d_axi_i2s_audio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_d_axi_i2s_audio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_d_axi_i2s_audio_0_0.tcl
