...
HD_PWD='D:/WorkRaduV/Projects/Zybo-Z7/hw/proj/hw.runs/system_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_us_1.tcl
